...
extern "C" {
    ...
    {
        ERESULT         eRc;
        SQLROWDEF_DATA   *pObject = OBJ_NIL;
        const
        OBJ_INFO        *pInfo;
        //int64_t         intIn;
        //ASTR_DATA       *pWrk;

        pInfo = obj_getInfo(SqlRowDef_Class());
        ...
        pObject = SqlRowDef_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  SqlRowDef_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = SqlRowDef_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = SqlRowDef_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = SqlRowDef_ToJsonFields(this, pStr);      
