...
extern "C" {
    ...
    {
        ERESULT         eRc;
        SQLCOLDEF_DATA   *pObject = OBJ_NIL;
        const
        OBJ_INFO        *pInfo;
        //int64_t         intIn;
        //ASTR_DATA       *pWrk;

        pInfo = obj_getInfo(SqlColDef_Class());
        ...
        pObject = SqlColDef_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  SqlColDef_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = SqlColDef_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = SqlColDef_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = SqlColDef_ToJsonFields(this, pStr);      
