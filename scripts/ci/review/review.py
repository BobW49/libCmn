...
This module reviews the go application(s) generated by genapp.
...
def         perform_actions():
    ...
    if args.verbose > 0:
        print('*****************************************')
        print('*        Reviewing the Application      *')
        print('*****************************************')
        print()
    #rc = util.do_cmd("./jenkins/review/review.py", 'app01ma')
    #if not rc == 0:
    #print("Error: Reviewing failed for: 'app01ma'!\n")
    #return 4
