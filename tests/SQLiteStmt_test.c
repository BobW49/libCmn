...
//****************************************************************
//          SQLite Statement (SQLiteStmt)  Test Program
//****************************************************************
...
extern "C" {
    ...
    ERESULT         Test_SQLiteStmt_OpenClose (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    ...
    #ifdef   SQLITESTMT_MSGS
            SQLiteStmt_setMsg(pObj, (void *)Test_MsgInfo, (void *)Test_MsgWarn, this);
    #endif
    ...
    ERESULT         Test_SQLiteStmt_Copy01 (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    {
    ...
    #if defined(SQLITESTMT_JSON_SUPPORT)
        ...
        if (pObj1) {
            ...
            TestForTrue(fRc, "Failed Ident Test");
    #ifdef   SQLITESTMT_MSGS
            SQLiteStmt_setMsg(pObj1, (void *)Test_MsgInfo, (void *)Test_MsgWarn, this);
    #endif
            ...
            TestForTrue(fRc, "Failed Ident Test");
            //iRc = SQLiteStmt_Compare(pObj1, pObj2);
    ...
    ERESULT         Test_SQLiteStmt_Test01 (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    {
        ...
        if (pObj) {
            ...
            {
                ASTR_DATA       *pStr = SQLiteStmt_ToDebugString(pObj, 4);
                if (pStr) {
    ...
    ERESULT         Test_SQLiteStmt_Test02 (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    ...
    ERESULT         Test_SQLiteStmt_Test03 (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    ...
    ERESULT         Test_SQLiteStmt_Test04 (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    ...
    )
    {
        ...
        //                                             Setup TearDown
        TestExec("OpenClose", Test_SQLiteStmt_OpenClose, NULL,   NULL);
#ifdef  TEST_ASSIGN_COPY
        TestExec("Copy01", Test_SQLiteStmt_Copy01,       NULL,   NULL);
#endif
        TestExec("Test01", Test_SQLiteStmt_Test01,       NULL,   NULL);
        TestExec("Test02", Test_SQLiteStmt_Test02,       NULL,   NULL);
        TestExec("Test03", Test_SQLiteStmt_Test03,       NULL,   NULL);
        TestExec("Test04", Test_SQLiteStmt_Test04,       NULL,   NULL);
