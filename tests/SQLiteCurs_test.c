...
//****************************************************************
//          SQLite Cursor (SQLiteCurs)  Test Program
//****************************************************************
...
extern "C" {
    ...
    ERESULT         Test_SQLiteCurs_OpenClose (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    ...
    #ifdef   SQLITECURS_MSGS
            SQLiteCurs_setMsg(pObj, (void *)Test_MsgInfo, (void *)Test_MsgWarn, this);
    #endif
    ...
    ERESULT         Test_SQLiteCurs_Copy01 (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    {
    ...
    #if defined(SQLITECURS_JSON_SUPPORT)
        ...
        if (pObj1) {
            ...
            TestForTrue(fRc, "Failed Ident Test");
    #ifdef   SQLITECURS_MSGS
            SQLiteCurs_setMsg(pObj1, (void *)Test_MsgInfo, (void *)Test_MsgWarn, this);
    #endif
            ...
            TestForTrue(fRc, "Failed Ident Test");
            //iRc = SQLiteCurs_Compare(pObj1, pObj2);
    ...
    ERESULT         Test_SQLiteCurs_Test01 (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    {
        ...
        if (pObj) {
            ...
            {
                ASTR_DATA       *pStr = SQLiteCurs_ToDebugString(pObj, 4);
                if (pStr) {
    ...
    ERESULT         Test_SQLiteCurs_Test02 (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    ...
    ERESULT         Test_SQLiteCurs_Test03 (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    ...
    ERESULT         Test_SQLiteCurs_Test04 (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    ...
    )
    {
        ...
        //                                             Setup TearDown
        TestExec("OpenClose", Test_SQLiteCurs_OpenClose, NULL,   NULL);
#ifdef  TEST_ASSIGN_COPY
        TestExec("Copy01", Test_SQLiteCurs_Copy01,       NULL,   NULL);
#endif
        TestExec("Test01", Test_SQLiteCurs_Test01,       NULL,   NULL);
        TestExec("Test02", Test_SQLiteCurs_Test02,       NULL,   NULL);
        TestExec("Test03", Test_SQLiteCurs_Test03,       NULL,   NULL);
        TestExec("Test04", Test_SQLiteCurs_Test04,       NULL,   NULL);
