...
//****************************************************************
//          An Array of Value Objects (ValueArray)  Test Program
//****************************************************************
...
extern "C" {
    ...
    ERESULT         Test_ValueArray_OpenClose (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    ...
    #ifdef   VALUEARRAY_MSGS
            ValueArray_setMsg(pObj, (void *)Test_MsgInfo, (void *)Test_MsgWarn, this);
    #endif
    ...
    ERESULT         Test_ValueArray_Copy01 (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    {
    ...
    #if defined(VALUEARRAY_JSON_SUPPORT)
        ...
        if (pObj1) {
            ...
            TestForTrue(fRc, "Failed Ident Test");
    #ifdef   VALUEARRAY_MSGS
            ValueArray_setMsg(pObj1, (void *)Test_MsgInfo, (void *)Test_MsgWarn, this);
    #endif
    ...
    ERESULT         Test_ValueArray_Test01 (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    ...
    ERESULT         Test_ValueArray_Test02 (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    ...
    ERESULT         Test_ValueArray_Test03 (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    ...
    ERESULT         Test_ValueArray_Test04 (
        TEST_DATA       *this,
        const
        char            *pTestName
    )
    ...
    )
    {
        ...
        //                                             Setup TearDown
        TestExec("OpenClose", Test_ValueArray_OpenClose, NULL,   NULL);
#ifdef  TEST_ASSIGN_COPY
        TestExec("Copy01", Test_ValueArray_Copy01,       NULL,   NULL);
#endif
        TestExec("Test01", Test_ValueArray_Test01,       NULL,   NULL);
        TestExec("Test02", Test_ValueArray_Test02,       NULL,   NULL);
        TestExec("Test03", Test_ValueArray_Test03,       NULL,   NULL);
        TestExec("Test04", Test_ValueArray_Test04,       NULL,   NULL);
