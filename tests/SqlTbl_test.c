...
extern "C" {
    ...
    #ifdef   SQLTBL_MSGS
            SqlTbl_setMsg(pObj, (void *)Test_MsgInfo, (void *)Test_MsgWarn, this);
    #endif
    ...
    )
    {
    ...
    #if defined(SQLTBL_JSON_SUPPORT)
        ...
        if (pObj1) {
            ...
            TestForTrue(fRc, "Failed Ident Test");
    #ifdef   SQLTBL_MSGS
            SqlTbl_setMsg(pObj1, (void *)Test_MsgInfo, (void *)Test_MsgWarn, this);
    #endif
            ...
            TestForTrue(fRc, "Failed Ident Test");
            //iRc = SqlTbl_Compare(pObj1, pObj2);
    ...
    )
    {
        ...
        if (pObj) {
            ...
            {
                ASTR_DATA       *pStr = SqlTbl_ToDebugString(pObj, 4);
                if (pStr) {
    ...
    )
    {
        ...
        //                                             Setup TearDown
        TestExec("OpenClose", Test_SqlTbl_OpenClose, NULL,   NULL);
#ifdef  TEST_ASSIGN_COPY
        TestExec("Copy01", Test_SqlTbl_Copy01,       NULL,   NULL);
#endif
        TestExec("Test01", Test_SqlTbl_Test01,       NULL,   NULL);
        TestExec("Test02", Test_SqlTbl_Test02,       NULL,   NULL);
        TestExec("Test03", Test_SqlTbl_Test03,       NULL,   NULL);
        TestExec("Test04", Test_SqlTbl_Test04,       NULL,   NULL);
