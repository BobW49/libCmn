...
ERESULT         Test_NetHTTPR_OpenClose (
    TEST_DATA       *this,
    const
    char            *pTestName
)
...
#ifdef   NETHTTPR_MSGS
        NetHTTPR_setMsg(pObj, (void *)Test_MsgInfo, (void *)Test_MsgWarn, this);
#endif
...
)
{
    ...
    if (pObj1) {
        ...
        TestForTrue(fRc, "Failed Ident Test");
#ifdef   NETHTTPR_MSGS
        NetHTTPR_setMsg(pObj1, (void *)Test_MsgInfo, (void *)Test_MsgWarn, this);
#endif
...
)
{
    ...
    // Execute tests.
    TestExec("OpenClose", Test_NetHTTPR_OpenClose, NULL, NULL);
    //TestExec("Copy01", Test_NetHTTPR_Copy01, NULL, NULL);
    TestExec("Test01", Test_NetHTTPR_Test01, NULL, NULL);
    TestExec("Test02", Test_NetHTTPR_Test02, NULL, NULL);
    TestExec("Test03", Test_NetHTTPR_Test03, NULL, NULL);
    TestExec("Test04", Test_NetHTTPR_Test04, NULL, NULL);
