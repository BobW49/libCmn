...
extern "C" {
    ...
    #ifdef   SQLROW_MSGS
            SqlRow_setMsg(pObj, (void *)Test_MsgInfo, (void *)Test_MsgWarn, this);
    #endif
    ...
    )
    {
    ...
    #if defined(SQLROW_JSON_SUPPORT)
        ...
        if (pObj1) {
            ...
            TestForTrue(fRc, "Failed Ident Test");
    #ifdef   SQLROW_MSGS
            SqlRow_setMsg(pObj1, (void *)Test_MsgInfo, (void *)Test_MsgWarn, this);
    #endif
            ...
            TestForTrue(fRc, "Failed Ident Test");
            //iRc = SqlRow_Compare(pObj1, pObj2);
    ...
    )
    {
        ...
        if (pObj) {
            ...
            {
                ASTR_DATA       *pStr = SqlRow_ToDebugString(pObj, 4);
                if (pStr) {
    ...
    )
    {
        ...
        //                                             Setup TearDown
        TestExec("OpenClose", Test_SqlRow_OpenClose, NULL,   NULL);
#ifdef  TEST_ASSIGN_COPY
        TestExec("Copy01", Test_SqlRow_Copy01,       NULL,   NULL);
#endif
        TestExec("Test01", Test_SqlRow_Test01,       NULL,   NULL);
        TestExec("Test02", Test_SqlRow_Test02,       NULL,   NULL);
        TestExec("Test03", Test_SqlRow_Test03,       NULL,   NULL);
        TestExec("Test04", Test_SqlRow_Test04,       NULL,   NULL);
