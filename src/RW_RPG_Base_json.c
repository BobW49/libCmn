...
//****************************************************************
// Report Program Generator (RPG) Base (RW_RPG_Base) JSON Support
//****************************************************************

/*
 * File:   RW_RPG_Base_json.c
 *
...
extern "C" {
    ...
    )
    {
        ...
        if (ERESULT_OK(eRc)) {
            ...
            if (pWrk) {
                RW_RPG_Base_setErrorStr(pObject, pWrk);
                obj_Release(pWrk);
            }
    ...
    )
    {
        ...
        pInfo = obj_getInfo(RW_RPG_Base_Class());
        ...
        pObject = RW_RPG_Base_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  RW_RPG_Base_ParseJsonFields(pParser, pObject);
        if (ERESULT_FAILED(eRc)) {
            obj_Release(pObject);
            pObject = OBJ_NIL;
        }
    ...
    )
    {
        ...
        pObject = RW_RPG_Base_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = RW_RPG_Base_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = RW_RPG_Base_ToJsonFields(this, pStr);      
