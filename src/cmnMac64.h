...
#ifndef DEBUG_BREAK
#   if (defined(__ARM32__) && __ARM32__) || (defined(__arm32__) && __arm32__)
#       ifdef NDEBUG
#           define DEBUG_BREAK()  /**/
#   else
#           define DEBUG_BREAK()\
...
#       endif
#   endif
#   if ((defined(__ARM64__) && __ARM64__) || (defined(__arm64__) && __arm64__))  && defined(__MACOS64_ENV__)
#       ifdef NDEBUG
#           define DEBUG_BREAK()  /**/
#   else
#           define DEBUG_BREAK( )\
                if (cmn_AmIBeingDebugged()) {__builtin_debugtrap();}
#endif
#   endif
#   if ((defined(__ARM64__) && __ARM64__) || (defined(__arm64__) && __arm64__)) && defined(__WIN64_ENV__)
#       ifdef NDEBUG
#           define DEBUG_BREAK()  /**/
#   else
#           define DEBUG_BREAK()\
                if (cmn_AmIBeingDebugged()) {asm("volatile("brk #0x2031");\n");}
#       endif
#   endif
#   if (defined(__x86_32__) && __x86_32__) || (defined(__X86_32__) && __X86_32__)
#       ifdef NDEBUG
#           define DEBUG_BREAK( )  /**/
#   else
#           define DEBUG_BREAK( )\
...
#       endif
#   endif
#   if (defined(__x86_64__) && __x86_64__) || (defined(__X86_64__) && __X86_64__)
#       ifdef NDEBUG
#           define DEBUG_BREAK( )  /**/
#   else
#           define DEBUG_BREAK( )\
