...
//****************************************************************
// Report Program Generator (RPG) Level (RW_RPG_Level) JSON Support
//****************************************************************

/*
 * File:   RW_RPG_Level_json.c
 *
...
extern "C" {
    ...
    )
    {
        ...
        if (ERESULT_OK(eRc)) {
            ...
            if (pWrk) {
                RW_RPG_Level_setErrorStr(pObject, pWrk);
                obj_Release(pWrk);
            }
    ...
    )
    {
        ...
        pInfo = obj_getInfo(RW_RPG_Level_Class());
        ...
        pObject = RW_RPG_Level_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  RW_RPG_Level_ParseJsonFields(pParser, pObject);
        if (ERESULT_FAILED(eRc)) {
            obj_Release(pObject);
            pObject = OBJ_NIL;
        }
    ...
    )
    {
        ...
        pObject = RW_RPG_Level_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = RW_RPG_Level_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = RW_RPG_Level_ToJsonFields(this, pStr);      
