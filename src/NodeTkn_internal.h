...
//****************************************************************
//              Node based on a Token (NodeTkn) Internal Header
//****************************************************************

/* 
 * File:   NodeTkn_internal.h
...
#ifndef NODETKN_INTERNAL_H
#define NODETKN_INTERNAL_H
...
#pragma pack(pop)
    ...
    extern
    struct NodeTkn_class_data_s  NodeTkn_ClassObj;
     ...
     */
    NODETKN_DATA *       NodeTkn_ParseJsonObject (
        JSONIN_DATA     *pParser
    );
    ...
    /*!
     ...
     @return    If successful, ERESULT_SUCCESS. Otherwise, an ERESULT_*
                error code.
     */
    ERESULT         NodeTkn_ParseJsonFields (
        JSONIN_DATA     *pParser,
        NODETKN_DATA     *pObject
    );
#endif
