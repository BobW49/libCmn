...
extern "C" {
    ...
    {
        ERESULT         eRc;
        VALUEARRAY_DATA   *pObject = OBJ_NIL;
        const
        OBJ_INFO        *pInfo;
        //int64_t         intIn;
        //ASTR_DATA       *pWrk;
        ...
        pInfo = obj_getInfo(ValueArray_Class());
        ...
        pObject = ValueArray_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  ValueArray_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = ValueArray_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = ValueArray_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = ValueArray_ToJsonFields(this, pStr);      
