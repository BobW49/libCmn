...
extern "C" {
    ...
    )
    {
        ...
        (void)JsonIn_FindU16NodeInHashA(pParser, "command", &pObject->cmd);
        (void)JsonIn_FindU16NodeInHashA(pParser, "majorRelease", &pObject->majRel);
        (void)JsonIn_FindU16NodeInHashA(pParser, "minorRelease", &pObject->minRel);
    ...
    )
    {
        ...
        pInfo = obj_getInfo(NetHTTPR_Class());
        ...
        pObject = NetHTTPR_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  NetHTTPR_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = NetHTTPR_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = NetHTTPR_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = NetHTTPR_ToJsonFields(this, pStr);      
    ...
    )
    {
        ...
        JsonOut_Append_u16("command", this->cmd, pStr);
        JsonOut_Append_u16("majorRelease", this->majRel, pStr);
        JsonOut_Append_u16("minorRelease", this->minRel, pStr);
