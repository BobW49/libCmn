...
extern
const
NODEENUM_VTBL       NodeEnum_VtblShared;
...
)
{
    ...
    if (NULL == this) {
        this = NodeEnum_New( );
        obj_setVtbl(this, (void *)&NodeEnum_VtblShared);
...
)
{
    ...
    if (this) {
        obj_setVtbl(this, (void *)&NodeEnum_Vtbl);
        obj_Release(this);
        NodeEnum_ClassObj.pSingleton = OBJ_NIL;
    }
            ...
            switch (*pStrA) {
                ...
                case 'S':
                    if (str_Compare("SuperClass", (char *)pStrA) == 0) {
                        return (void *)&NodeEnum_Info.pClassSuperObject;
                    }
                    break;
