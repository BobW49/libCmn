...
extern "C" {
    ...
    extern
    const
    NODELIST_VTBL       NodeList_VtblShared;
    ...
    )
    {
        ...
        if (NULL == this) {
            this = NodeList_New( );
            obj_setVtbl(this, (void *)&NodeList_VtblShared);
    ...
    )
    {
        ...
        if (this) {
            obj_setVtbl(this, (void *)&NodeList_Vtbl);
            obj_Release(this);
            NodeList_ClassObj.pSingleton = OBJ_NIL;
        }
                ...
                switch (*pStrA) {
                    ...
                    case 'S':
                        if (str_Compare("SuperClass", (char *)pStrA) == 0) {
                            return (void *)&NodeList_Info.pClassSuperObject;
                        }
                        break;
