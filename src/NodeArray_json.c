...
//****************************************************************
//              An Array of Nodes (NodeArray) JSON Support
//****************************************************************
...
extern "C" {
    ...
    )
    {
        ...
        if (ERESULT_OK(eRc)) {
            ...
            if (pWrk) {
                NodeArray_setErrorStr(pObject, pWrk);
                obj_Release(pWrk);
            }
    ...
    )
    {
        ...
        eRc =  NodeArray_ParseJsonFields(pParser, pObject);
        if (ERESULT_FAILED(eRc)) {
            obj_Release(pObject);
            pObject = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = NodeArray_ToJsonFields(this, pStr);
            USE_VAR(eRc);     
