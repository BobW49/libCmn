...
//****************************************************************
//      Specific Date and Time (RW_DateTime) JSON Support
//****************************************************************

/*
 * File:   RW_DateTime_json.c
 *
...
extern "C" {
    ...
    )
    {
        ...
        if (ERESULT_OK(eRc)) {
            ...
            if (pWrk) {
                RW_DateTime_setErrorStr(pObject, pWrk);
                obj_Release(pWrk);
            }
        ...
        pInfo = obj_getInfo(RW_DateTime_Class());
    ...
    )
    {
        ...
        pObject = RW_DateTime_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  RW_DateTime_ParseJsonFields(pParser, pObject);
        if (ERESULT_FAILED(eRc)) {
            obj_Release(pObject);
            pObject = OBJ_NIL;
        }
    ...
    )
    {
        ...
        pObject = RW_DateTime_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = RW_DateTime_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = RW_DateTime_ToJsonFields(this, pStr);      
    ...
    )
    {
        ...
        JsonOut_Append_u64("time", this->time, pStr);
