...
extern "C" {
    ...
    )
    {
        ...
        pInfo = obj_getInfo(SymList_Class());
        ...
        eRc =  SymList_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = SymList_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = SymList_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = SymList_ToJsonFields(this, pStr);      
