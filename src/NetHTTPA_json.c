...
extern "C" {
    ...
    )
    {
        ...
        (void)JsonIn_FindU16NodeInHashA(pParser, "code", &pObject->code);
    ...
    )
    {
        ...
        pInfo = obj_getInfo(NetHTTPA_Class());
        ...
        pObject = NetHTTPA_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  NetHTTPA_ParseJsonFields(pParser, pObject);
    ...
    )
    {
        ...
        pObject = NetHTTPA_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = NetHTTPA_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = NetHTTPA_ToJsonFields(this, pStr);      
    ...
    )
    {
        ...
        JsonOut_Append_u16("code", this->code, pStr);
