...
extern "C" {
    ...
    ****************************************************************/
    ...
    )
    {
        RW_RPG_LEVEL_DATA 
                        *this;
        uint32_t        cbSize = sizeof(RW_RPG_LEVEL_DATA);
    ...
    )
    {
        ...
        this = RW_RPG_Level_Alloc( );
        if (this) {
            this = RW_RPG_Level_Init(this);
        } 
        return this;
    }
    ...
    VALUE_DATA *    RW_RPG_Level_getOld (
        RW_RPG_LEVEL_DATA 
                        *this
    )
    {
...
#ifdef  NEED_ALL_GENERATED_CODE
    uint16_t        RW_RPG_Level_getPriority (
        RW_RPG_LEVEL_DATA 
                        *this
    )
    {
    ...
    /*!
     ...
     Example:
     @code 
        ERESULT eRc = RW_RPG_Level_Assign(this,pOther);
     @endcode 
     @param     this    object pointer
     @param     pOther  a pointer to another RW_RPG_LEVEL object
    ...
    )
    {
        ...
        if (!RW_RPG_Level_Validate(pOther)) {
            DEBUG_BREAK();
            return ERESULT_INVALID_OBJECT;
        }
#endif
    ...
    /*!
     ...
     Example:
     @code 
        RW_RPG_Level      *pCopy = RW_RPG_Level_Copy(this);
     @endcode 
     @param     this    object pointer
     @return    If successful, a RW_RPG_LEVEL object which must be 
...
#ifdef RW_RPG_LEVEL_IS_IMMUTABLE
        obj_Retain(this);
        pOther = this;
#else
        pOther = RW_RPG_Level_New( );
        if (pOther) {
            eRc = RW_RPG_Level_Assign(this, pOther);
    ...
    )
    {
        ...
        if (obj_IsEnabled(this)) {
            ((RW_RPG_LEVEL_VTBL *)obj_getVtbl(this))->devVtbl.pStop((OBJ_DATA *)this,NULL);
        }
#endif

        RW_RPG_Level_setStr(this, OBJ_NIL);
    ...
    /*!
     ...
     Example:
     @code 
        RW_RPG_Level      *pDeepCopy = RW_RPG_Level_Copy(this);
     @endcode 
     @param     this    object pointer
     @return    If successful, a RW_RPG_LEVEL object which must be 
                released, otherwise OBJ_NIL.
    ...
    )
    {
...
#else
        this = (OBJ_ID)obj_Init(this, cbSize, OBJ_IDENT_RW_RPG_LEVEL);
#endif
        if (OBJ_NIL == this) {
            DEBUG_BREAK();
            obj_Release(this);
        ...
        obj_setVtbl(this, (OBJ_IUNKNOWN *)&RW_RPG_Level_Vtbl);
#ifdef  RW_RPG_LEVEL_JSON_SUPPORT
        JsonIn_RegisterClass(RW_RPG_Level_Class());
#endif
...
//#if defined(__APPLE__)
        fprintf(
                stderr, 
                "RW_RPG_Level::sizeof(RW_RPG_LEVEL_DATA) = %lu\n", 
                sizeof(RW_RPG_LEVEL_DATA)
        );
#endif
        BREAK_NOT_BOUNDARY4(sizeof(RW_RPG_LEVEL_DATA));
#endif
    ...
    /*!
     ...
     @code
        ...
        void        *pMethod = RW_RPG_Level_QueryInfo(this, OBJ_QUERYINFO_TYPE_METHOD, "xyz");
     @endcode 
     ...
     @param     pData   for OBJ_QUERYINFO_TYPE_INFO, this field is not used,
                        ...
                        the object name, "RW_RPG_Level", prefix,
    ...
    )
    {
        ...
        switch (type) {
            ...
            case OBJ_QUERYINFO_TYPE_CLASS_OBJECT:
                return (void *)RW_RPG_Level_Class();
                break;
                ...
                switch (*pStrA) {
                    ...
                    case 'D':
                        if (str_Compare("Disable", (char *)pStrA) == 0) {
                            return RW_RPG_Level_Disable;
                        }
                        break;

                    case 'E':
                        if (str_Compare("Enable", (char *)pStrA) == 0) {
                            return RW_RPG_Level_Enable;
                        }
                        break;
                    ...
                    case 'T':
                        if (str_Compare("ToDebugString", (char *)pStrA) == 0) {
                            return RW_RPG_Level_ToDebugString;
                        }
#ifdef  RW_RPG_LEVEL_JSON_SUPPORT
            ...
            case OBJ_QUERYINFO_TYPE_PTR:
                if (pData == RW_RPG_Level_ToDebugString)
                    return "ToDebugString";
#ifdef  RW_RPG_LEVEL_JSON_SUPPORT
                if (pData == RW_RPG_Level_ToJson)
                    return "ToJson";
#endif
                break;
    ...
    )
    {
        ...
        //          in 'this' yet.
       if (this) {
            if (obj_IsKindOf(this, OBJ_IDENT_RW_RPG_LEVEL))
                ;
            else {
        ...
        if (!(obj_getSize(this) >= sizeof(RW_RPG_LEVEL_DATA))) {
            return false;
        }
