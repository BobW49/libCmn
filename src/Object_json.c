...
//****************************************************************
//              Base Object which everything inherits from (Object) JSON Support
//****************************************************************
...
extern "C" {
    ...
    /*!
     ...
     @return    If successful, ERESULT_SUCCESS. Otherwise, an ERESULT_*
                error code.
     */
    ERESULT     Object_ParseJsonFields (
        JSONIN_DATA     *pParser,
        OBJECT_DATA     *pObject
    )
    {
        ...
        if (ERESULT_OK(eRc)) {
            ...
            if (pWrk) {
                Object_setErrorStr(pObject, pWrk);
                obj_Release(pWrk);
            }
     ...
     */
    OBJECT_DATA *   Object_ParseJsonObject (
        JSONIN_DATA     *pParser
    )
    {
        ERESULT         eRc;
        OBJECT_DATA     *pObject = OBJ_NIL;
        const
        OBJ_INFO        *pInfo;
        //int64_t         intIn;
        //ASTR_DATA       *pWrk;
        ...
        pInfo = obj_getInfo(Object_Class());
        ...
        eRc =  Object_ParseJsonFields(pParser, pObject);
        if (ERESULT_FAILED(eRc)) {
            obj_Release(pObject);
            pObject = OBJ_NIL;
        }
    ...
    )
    {
        ...
        pObject = Object_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = Object_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = Object_ToJsonFields(this, pStr);
            USE_VAR(eRc);     
