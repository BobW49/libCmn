...
struct Main_data_s	{
    ...
    DICT_DATA       *pDict;
    ASTRARRAY_DATA  *pDefines;      // An array of strings where
    //                              // the string is the left side
    //                              // of an equation, (ie x of x=y).
    //                              // The string's other property
    //                              // contains the optional right
