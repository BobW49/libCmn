...
extern "C" {
    ...
    )
    {
        ...
        if (ERESULT_OK(eRc)) {
            ...
            if (pWrk) {
                ClassItems_setErrorStr(pObject, pWrk);
                obj_Release(pWrk);
            }
    ...
    {
        ERESULT         eRc;
        CLASSITEMS_DATA   *pObject = OBJ_NIL;
        const
        OBJ_INFO        *pInfo;
        //int64_t         intIn;
        //ASTR_DATA       *pWrk;
        ...
        pInfo = obj_getInfo(ClassItems_Class());
        ...
        pObject = ClassItems_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  ClassItems_ParseJsonFields(pParser, pObject);
        if (ERESULT_FAILED(eRc)) {
            obj_Release(pObject);
            pObject = OBJ_NIL;
        }
    ...
    )
    {
        ...
        pObject = ClassItems_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = ClassItems_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = ClassItems_ToJsonFields(this, pStr);      
