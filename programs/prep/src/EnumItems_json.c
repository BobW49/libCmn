...
extern "C" {
    ...
    )
    {
        ...
        if (ERESULT_OK(eRc)) {
            ...
            if (pWrk) {
                EnumItems_setErrorStr(pObject, pWrk);
                obj_Release(pWrk);
            }
    ...
    {
        ERESULT         eRc;
        ENUMITEMS_DATA   *pObject = OBJ_NIL;
        const
        OBJ_INFO        *pInfo;
        //int64_t         intIn;
        //ASTR_DATA       *pWrk;
        ...
        pInfo = obj_getInfo(EnumItems_Class());
        ...
        pObject = EnumItems_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  EnumItems_ParseJsonFields(pParser, pObject);
        if (ERESULT_FAILED(eRc)) {
            obj_Release(pObject);
            pObject = OBJ_NIL;
        }
    ...
    )
    {
        ...
        pObject = EnumItems_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = EnumItems_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = EnumItems_ToJsonFields(this, pStr);      
