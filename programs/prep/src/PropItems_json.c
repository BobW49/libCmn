...
extern "C" {
    ...
    )
    {
        ...
        if (ERESULT_OK(eRc)) {
            ...
            if (pWrk) {
                PropItems_setErrorStr(pObject, pWrk);
                obj_Release(pWrk);
            }
    ...
    {
        ERESULT         eRc;
        PROPITEMS_DATA   *pObject = OBJ_NIL;
        const
        OBJ_INFO        *pInfo;
        //int64_t         intIn;
        //ASTR_DATA       *pWrk;
        ...
        pInfo = obj_getInfo(PropItems_Class());
        ...
        pObject = PropItems_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  PropItems_ParseJsonFields(pParser, pObject);
        if (ERESULT_FAILED(eRc)) {
            obj_Release(pObject);
            pObject = OBJ_NIL;
        }
    ...
    )
    {
        ...
        pObject = PropItems_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = PropItems_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = PropItems_ToJsonFields(this, pStr);      
