...
extern "C" {
    ...
    )
    {
        ...
        if (ERESULT_OK(eRc)) {
            ...
            if (pWrk) {
                NodeEnum_setErrorStr(pObject, pWrk);
                obj_Release(pWrk);
            }
    ...
    )
    {
        ...
        pInfo = obj_getInfo(NodeEnum_Class());
        ...
        pObject = NodeEnum_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  NodeEnum_ParseJsonFields(pParser, pObject);
        if (ERESULT_FAILED(eRc)) {
            obj_Release(pObject);
            pObject = OBJ_NIL;
        }
    ...
    )
    {
        ...
        pObject = NodeEnum_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = NodeEnum_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = NodeEnum_ToJsonFields(this, pStr);      
