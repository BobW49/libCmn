 ...
 * Purpose
 *          This object provides for parsing and processing the 
 *          command line arguments, and supplies program command 
 *          line documentation to the user.
 *
 * Remarks
 *  1.      None
 *
...
/*----------------------------------------------------------------
    ...
    in the _idents_e enum:
        OBJ_IDENT_MAIN,             //  Main Program Processing
        OBJ_IDENT_MACRO_CLASS,
        (NOTE: The above is already supplied in "cmn_defs.h".)
    The following should be added to the appropriate objects.json.txt
    or program.json.txt file:
        {name:"Main",  desc:"Main Program Processing"},
 *----------------------------------------------------------------*/
