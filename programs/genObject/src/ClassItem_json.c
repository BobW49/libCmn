...
extern "C" {
    ...
    )
    {
        ...
        if (ERESULT_OK(eRc)) {
            ...
            if (pWrk) {
                ClassItem_setErrorStr(pObject, pWrk);
                obj_Release(pWrk);
            }
    ...
    {
        ERESULT         eRc;
        CLASSITEM_DATA   *pObject = OBJ_NIL;
        const
        OBJ_INFO        *pInfo;
        //int64_t         intIn;
        //ASTR_DATA       *pWrk;
        ...
        pInfo = obj_getInfo(ClassItem_Class());
        ...
        pObject = ClassItem_New( );
        if (OBJ_NIL == pObject) {
            goto exit00;
        }
        
        eRc =  ClassItem_ParseJsonFields(pParser, pObject);
        if (ERESULT_FAILED(eRc)) {
            obj_Release(pObject);
            pObject = OBJ_NIL;
        }
    ...
    )
    {
        ...
        pObject = ClassItem_ParseJsonObject(pParser);
    ...
    )
    {
        ...
        if (pStringA) {
            ...
            pObject = ClassItem_NewFromJsonString(pStr);
            obj_Release(pStr);
            pStr = OBJ_NIL;
        }
    ...
    )
    {
        ...
        if (pStr) {
            ...
            eRc = ClassItem_ToJsonFields(this, pStr);      
