...
)
{
    ...
    const
    char            *pPathA = TEST_FILES_DIR "/enum_test_001.txt";
    ...
    if (pObj) {
        ...
        eRc = Exec_Exec(pObj, pPath, OBJ_NIL, "Sym", "Prim", NULL, NULL);
        TestForSuccess("");
...
)
{
    ...
    const
    char            *pPathA = TEST_FILES_DIR "/enum_test_002.txt";
...
)
{
    ...
    ASTR_DATA       *pStart = OBJ_NIL;
    const
    char            *pPathA = TEST_FILES_DIR "/enum_test_003.txt";
    ...
    if (pObj) {
        ...
        eRc = Exec_Exec(pObj, pPath, OBJ_NIL, "Sym", "Prim", "~/git/", NULL);
        TestForSuccess("");
...
)
{
    ...
    TestExec("Read03", Test_Exec_Read03, NULL, NULL);
